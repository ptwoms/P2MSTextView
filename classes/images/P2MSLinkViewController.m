...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ((showTitle && indexPath.section == 2) || (!showTitle && indexPath.section == 1)) {
        ...
        if (!cell) {
            ...
            [loginButton setBackgroundImage:[P2MSFunctions imageWithColor:[UIColor lightGrayColor]] forState:UIControlStateNormal];
            [loginButton setBackgroundImage:[P2MSFunctions imageWithColor:[UIColor grayColor]] forState:UIControlStateHighlighted];
