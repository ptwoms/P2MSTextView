...
- (void)beginCaretForRect:(CGRect)begin endCaretForRect:(CGRect)end{
    ...
    if (_leftCaret == nil) {
        ...
        _leftCaret.backgroundColor = [P2MSConstants caretColor];
        [self addSubview:_leftCaret];
        
        UIImage *image = [UIImage imageNamed:@"drag-dot.png"];
        ...
        _rightCaret.backgroundColor = [P2MSConstants caretColor];
        ...
        [(UIImageView *)_rightDot setImage:[UIImage imageNamed:@"drag-dot.png"]];
